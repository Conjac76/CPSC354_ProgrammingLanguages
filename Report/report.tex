...
\noindent \textbf{Question on Discord:} "In lambda calculus, how does normalization ensure that each function application reaches a unique reduced form, and are there cases where this process doesn’t terminate?"
